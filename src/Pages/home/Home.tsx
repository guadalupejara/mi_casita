...
>
  <div className="bg-orange-900 bg-opacity-75 px-4 py-6 sm:px-6 sm:py-8 md:px-10 md:py-10 max-w-3xl w-full rounded-lg">
    <h1 className="text-xl sm:text-2xl md:text-4xl font-bold mb-4">
      Welcome To Your Casita {people[1].firstName}
    </h1>
